...
public class Faculty extends JFrame implements ActionListener {
    ...
    private JTextField textName, textfather, textAddress, textPhone,
            textemail, textM10, textM12, textAadhar;
    ...
    // ========== GETTERS ==========
    public String getFacultyName()   { return textName.getText(); }
    ...
    public String getQualification() { return (String) qualificationBox.getSelectedItem(); }
    public String getDepartment()    { return (String) departmentBox.getSelectedItem(); }
    ...
    Faculty() {
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("facultylogo.png"));
        ...
        ImageIcon icon = new ImageIcon(ClassLoader.getSystemResource("teacherlogo.png"));
        Image img = icon.getImage().getScaledInstance(870, 200, Image.SCALE_SMOOTH);
        JLabel imageLabel = new JLabel(new ImageIcon(img));
        imageLabel.setBounds(140, 60, 870, 200);
        add(imageLabel);
        ...
        formPanel.add(createLabel("Employee ID", 70, 90));
        empText = new JLabel("101" + f4);
        ...
        textAadhar = createField(610, 240, formPanel);

        formPanel.add(createLabel("Qualification", 70, 290));
        String qualification[] = {"BA", "BSc", "BS", "BBA", "MA", "MSc", "MS", " M.Phil", "PhD"};
        qualificationBox = new JComboBox<>(qualification);
        qualificationBox.setBounds(200, 290, 150, 30);
        formPanel.add(qualificationBox);

        formPanel.add(createLabel("Department", 470, 290));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            // Using getters — encapsulated data access
            String name          = getFacultyName();
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Teacher Details Inserted");
                setVisible(false);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
